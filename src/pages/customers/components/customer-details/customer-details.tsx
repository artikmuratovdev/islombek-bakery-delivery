        ...
        <div className="space-y-5">
          <div className="w-full h-32 bg-white rounded-lg border border-yellow-400">
            <div className="flex justify-between items-center px-3 mt-1">
              <h3 className="text-blue-950 text-base font-bold font-['Inter'] leading-tight">
                Izzat
              </h3>
              <h2 className="text-red-700 text-base font-semibold font-['Inter'] leading-none w-20 h-7 bg-gray-200 rounded-[10px] flex justify-center items-center">
                10:45
              </h2>
              <h2 className="text-blue-950 text-base font-semibold font-['Inter'] leading-none w-20 h-7 bg-gray-200 rounded-[10px] flex justify-center items-center">
                <Clock /> 06:00
              </h2>
              <h2 className="text-green-700 text-base font-semibold font-['Inter'] leading-none w-20 h-7 bg-gray-200 rounded-[10px] flex justify-center items-center">
                10:51
              </h2>
            </div>
