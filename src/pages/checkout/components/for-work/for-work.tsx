  ...
  return (
    <div>
      <div className="w-full h-10 relative bg-red-700 rounded-lg outline outline-1 outline-offset-[-1px] outline-red-700 overflow-hidden flex justify-between items-center px-6">
          ...
          <h2>
            <DropdownMenu open={open} onOpenChange={setOpen}>
              ...
              <DropdownMenuContent className="w-40">
                <DropdownMenuCheckboxItem className="text-blue-950 text-sm font-semibold flex justify-start gap-x-2">
                  <Edit className="ml-[-20px]" /> Tahrirlash
                </DropdownMenuCheckboxItem>
                <DropdownMenuSeparator />
                <DropdownMenuCheckboxItem className="text-red-700 text-sm font-semibold flex justify-start gap-x-2">
        ...
        <div
          className="w-[360px] h-10 bg-white rounded-lg outline outline-2 outline-offset-[-2px] outline-yellow-400 fixed bottom-[40px] right-4 flex justify-center items-center"
          onClick={() => setOpenCheck(true)}
        >
          <h3 className="text-blue-950 text-base font-semibold font-['Inter'] leading-none">
            Kassani yopish
          </h3>
        </div>
        <Button
      ...
      <BottomSheet
        open={openPlus}
        setOpen={setOpenPlus}
        children={<Bottom onClose={() => setOpenPlus(false)} />}
      />
      <BottomSheet
        open={openCheck}
        setOpen={setOpenCheck}
        children={<BottomCheck onClose={() => setOpenCheck(false)} />}
      />
    </div>
  );
};
