...
export const OrderPage = () => {
  ...
  const [submitPreOrder, { isLoading }] = useSubmitPreOrderMutation();
  ...
  return (
    <div className="w-full max-w-2xl pb-20">
      ...
      <div className=" mt-2 px-4 flex flex-col space-y-2 items-start">
        <Button
          className="w-36 h-9 p-3 bg-yellow-400 rounded-lg text-[#1C2C57] inline-flex justify-center items-center gap-1 hover:bg-yellow-400 font-bold disabled:opacity-50 disabled:cursor-not-allowed"
          onClick={submitting}
          disabled={isLoading}
        >
