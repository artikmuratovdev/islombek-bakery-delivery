...
export const Incomes = ({ onClose }: Props) => {
    return (
        <div>
            <div className="w-full h-9 relative bg-white rounded-lg outline outline-1 outline-offset-[-1px] outline-yellow-400 mt-5 flex justify-between items-center px-6 mb-5">
            ...
            <div className="w-full h-9 relative bg-white rounded-lg outline outline-1 outline-offset-[-1px] outline-yellow-400 flex justify-center items-center">
                <h2 className="text-blue-950 text-base font-semibold font-['Inter']">Fresh market</h2>
            </div>
